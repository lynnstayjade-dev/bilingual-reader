...
const articles = [
  ...
  {
    id: 'sample-boring-companies',
    source: 'Lumina 编辑部 · 示范',
    sourceUrl: '',
    license: '原创示范内容（用于展示阅读器，非真实刊物文章）',
    category: 'business',
    level: 'C1 · IELTS 7.5',
    date: '2026-08-22',
    byline: 'Lumina Editorial',
    readingMin: 6,
    title: 'The Quiet Power of Boring Companies',
    titleCn: '无聊公司的静默力量',
    excerpt: 'The most resilient businesses are rarely the most exciting ones. They compound quietly, year after year, while the market chases the next headline.',
    excerptCn: '最具韧性的企业很少是最令人兴奋的那些。它们年复一年地安静复利，而市场却在追逐下一个头条。',
    tags: ['business', 'strategy', 'investing', 'resilience'],
    collocations: ['quiet power', 'compound quietly', 'chases the headline', 'moat', 'pricing power', 'riding the cycle', 'earnings streak'],
    quotes: [
      { text: 'Boring is a moat. Nobody wants to disrupt a business they do not understand.', who: 'Lumina 编辑部' },
      { text: 'The market pays a premium for excitement and a discount for predictability.', who: 'Lumina 编辑部' }
    ],
    body: [
      'The most resilient businesses are rarely the most exciting ones. They compound quietly, year after year, while the market chases the next headline.',
      'Consider the maker of industrial valves, the regional waste handler, the specialized insurer. Their products are invisible. Their quarterly calls are dull. Yet many have delivered an earnings streak longer than any celebrity startup.',
      'Boring is a moat. Nobody wants to disrupt a business they do not understand, and few analysts bother to model a company whose only news is a new warehouse.',
      'This quietness carries a second advantage: pricing power. When a product is small, mission-critical, and hard to substitute, the buyer cares more about reliability than price. The valve company can raise prices without losing customers.',
      'Investors, however, systematically underweight such firms. The market pays a premium for excitement and a discount for predictability. That gap is where patient capital earns its return.',
      'The lesson is not to avoid growth. It is to separate the companies riding the cycle from the ones that own the cycle. The former look like compounders until the music stops. The latter keep compounding through the noise.',
      'Build a portfolio the way you build a roof: not for the sunny day, but for the storm you cannot predict. Boring companies are the trusses you forget you have—until the wind comes.'
    ],
    bodyCn: [
      '最具韧性的企业很少是最令人兴奋的那些。它们年复一年地安静复利，而市场却在追逐下一个头条。',
      '想想工业阀门制造商、地区废弃物处理商、专业保险公司。它们的产品看不见，财报电话会枯燥乏味。然而许多公司的盈利连增纪录，比任何明星初创企业都长。',
      '无聊是一道护城河。没人想颠覆一家自己看不懂的企业，也几乎没有分析师愿意为一家"唯一新闻就是新盖了座仓库"的公司建模。',
      '这种安静带来第二个优势：定价权。当一件产品微小、关乎关键任务且难以替代时，买家更在意可靠性而非价格。阀门公司可以涨价而不流失客户。',
      '然而投资者系统性地低配这类公司。市场为"兴奋"支付溢价，为"可预测"给出折价。那道鸿沟，正是耐心资本获取回报之处。',
      '教训不是回避增长，而是要把"搭周期顺风"的公司与"拥有周期"的公司区分开。前者在音乐停止前看起来像复利机器；后者则穿越喧嚣持续复利。',
      '构建投资组合要像盖屋顶：不是为晴天，而是为无法预测的暴风雨。无聊公司是你忘了自己拥有的桁架——直到大风来袭。'
    ]
  },
  {
    id: 'sample-ocean-limits',
    source: 'Lumina 编辑部 · 示范',
    sourceUrl: '',
    license: '原创示范内容（用于展示阅读器，非真实刊物文章）',
    category: 'science',
    ...
    byline: 'Lumina Editorial',
    readingMin: 6,
    title: 'Why We Keep Misreading the Ocean\'s Limits',
    titleCn: '我们为何一再误读海洋的极限',
    excerpt: 'The sea looks inexhaustible because its scale hides the speed of our taking. Collapse arrives not with a wave, but with a silence.',
    excerptCn: '海洋看似取之不尽，因为它的辽阔掩盖了我们攫取的速度。崩溃到来的方式不是巨浪，而是寂静。',
    tags: ['ocean', 'climate', 'ecology', 'sustainability'],
    collocations: ['looks inexhaustible', 'hides the speed', 'arrives not with a wave but with a silence', 'tipping point', 'creature by creature', 'the canary in the fjord'],
    quotes: [
      { text: 'We measure the ocean in tonnes and forget to measure it in generations.', who: 'Lumina 编辑部' },
      { text: 'A system that looks stable and is not is the most dangerous system of all.', who: 'Lumina 编辑部' }
    ],
    body: [
      'The sea looks inexhaustible because its scale hides the speed of our taking. Collapse arrives not with a wave, but with a silence.',
      'For decades we treated the ocean as a buffer: a sink for carbon, a source of protein, a sewer for excess. Each input seemed harmless because the water was vast. Each output seemed small because the catch was local.',
      'But thresholds are not linear. A fishery can appear healthy while its breeding stock quietly thins, creature by creature, until one season the nets come up empty. The tipping point is crossed long before the crash is visible.',
      'The warning signs are specific. Smaller fish, fewer old giants, shifting migration, bleached reefs. We read them as weather, not as signal. The canary in the fjord does not sing less because it is tired.',
      'What makes the ocean different from land is feedback. Damage underwater is slower to see and slower to reverse. Restore a forest and you watch it green within a decade. Restore a kelp forest and you may wait a generation.',
      'We measure the ocean in tonnes and forget to measure it in generations. A system that looks stable and is not is the most dangerous system of all.',
      'The cure is unglamorous: smaller fleets, stricter limits, protected nurseries, and the patience to let silence refill. The ocean will recover if we let it. The only question is whether we stop in time.'
    ],
    bodyCn: [
      '海洋看似取之不尽，因为它的辽阔掩盖了我们攫取的速度。崩溃到来的方式不是巨浪，而是寂静。',
      '数十年来，我们视海洋为缓冲器：碳的汇、蛋白质的源、过剩物的下水道。每一样输入似乎都无害，因为水太广；每一样输出似乎都微小，因为捕捞是局部的。',
      '但阈值并非线性。一片渔场在繁殖群体悄然缩减时仍可看似健康，一只一只地减少，直到某个季节渔网空空如也。 tipping point（临界点）在崩溃显现之前很久就已经跨过。',
      '警告信号是具体的：鱼更小、老巨物更少、洄游改变、珊瑚白化。我们将其读作战时天气，而非信号。峡湾里的金丝雀歌声变弱，不是因为它累了。',
      '海洋不同于陆地之处，在于反馈。水下的损害更晚被看见，也更晚被逆转。恢复一片森林，十年内可见葱绿；恢复一片海藻林，或许要等一代人。',
      '我们用吨来衡量海洋，却忘了用世代来衡量。一个看似稳定实则不然的系统，是最危险的系统。',
      '解药毫不光鲜：更小的船队、更严的限额、受保护的繁育场，以及让寂静重新充盈的耐心。只要我们放手，海洋会恢复。唯一的问题是：我们能否及时停下。'
    ]
  }
];
